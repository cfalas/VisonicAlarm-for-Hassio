...
from homeassistant.const import STATE_UNKNOWN, STATE_OPEN, STATE_CLOSED
        ...
        if device is not None:
            if device.subtype is not None:
                if (
                    ...
                    or device.subtype == "MOTION_CAMERA"
                    or device.subtype == "MOTION"
                    or device.subtype == "MOTION_DUAL"
                    or device.subtype == "MOTION_V_ANTIMASK"
                    or device.subtype == "CURTAIN"
                ):
                    _LOGGER.debug(
